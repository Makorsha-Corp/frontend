// src/legacy-reference/business-lens/BusinessLensWizardPage.tsx
import BusinessLensOrdersReport from "./BusinessLensReports/BusinessLensOrdersReport";
import BusinessLensPartReport from "./BusinessLensReports/BusinessLensPartReport";
