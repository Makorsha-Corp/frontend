...
export interface AccountOpenInvoicesPageApiResponse {
  items: AccountInvoiceApiResponse[];
  total: number;
  skip: number;
  limit: number;
  has_more: boolean;
...
export interface AccountOpenInvoicesPage {
...
export interface AccountOpenInvoicesPageParams {
  account_id: number;
  skip?: number;
  limit?: number;
  prioritize_purchase_order_id?: number;
}

export interface AccountInvoicesPageParams {
  account_id: number;
  skip?: number;
  limit?: number;
  invoice_type?: 'payable' | 'receivable';
...
export interface InvoiceHubTypeSummaryApi {
  open_count: number;
  outstanding_total: string;
  overdue_count: number;
  accounts_with_open_count: number;
}

export interface InvoiceHubTypeSummary {
  openCount: number;
  outstandingTotal: number;
  overdueCount: number;
  accountsWithOpenCount: number;
}

export interface AccountInvoicesHubSummaryApiResponse {
  payable: InvoiceHubTypeSummaryApi;
  receivable: InvoiceHubTypeSummaryApi;
  total_active_accounts: number;
  accounts_with_any_open_balance: number;
}

export interface AccountInvoicesHubSummary {
  payable: InvoiceHubTypeSummary;
  receivable: InvoiceHubTypeSummary;
  totalActiveAccounts: number;
  accountsWithAnyOpenBalance: number;
}
