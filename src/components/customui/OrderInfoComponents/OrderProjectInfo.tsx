...
interface OrderProjectInfoProps {
    order: Order
    mode: 'view' | 'manage' | 'default'
}

const OrderProjectInfo: React.FC<OrderProjectInfoProps> = ({ order, mode }) => {
    ...
    useEffect(() => {
        ...
        loadProjectData()
    }, [order.id, order.project_id, order.project_component_id])
...
export default OrderProjectInfo
