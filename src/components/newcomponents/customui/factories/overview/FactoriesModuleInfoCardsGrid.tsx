...
import FactoriesModuleKpiStrip from '@/components/newcomponents/customui/factories/overview/FactoriesModuleKpiStrip';
...
const FactoriesModuleInfoCardsGrid: React.FC<FactoriesModuleInfoCardsGridProps> = ({
  ...
  <>
    ...
    <div className="hidden h-full min-h-0 grid-cols-3 items-stretch gap-4 overflow-hidden lg:grid">
