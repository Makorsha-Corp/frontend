...
export interface ManageEoApprovalsDialogProps {
  open: boolean;
...
const ManageEoApprovalsDialog: React.FC<ManageEoApprovalsDialogProps> = ({
  open,
  onOpenChange,
  approvers,
  assignableMembers,
    ...
    <DialogContent className="flex h-[66vh] max-h-[66vh] w-[min(42rem,94vw)] max-w-none flex-col gap-0 overflow-hidden p-0 sm:max-w-none">
      ...
      <div className="flex flex-1 min-h-0 flex-col gap-4 overflow-y-auto px-6 py-4">
        <div className="flex items-center justify-between gap-3">
          <Label htmlFor="eo-required-approvals" className="text-sm text-muted-foreground">
            Required approvals
          </Label>
          <Input
            id="eo-required-approvals"
            type="number"
            min={0}
...
export default ManageEoApprovalsDialog;
