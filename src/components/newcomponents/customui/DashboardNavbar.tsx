...
const DashboardNavbar: React.FC<DashboardNavbarProps> = ({ onCollapsedChange }) => {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`relative z-10 flex h-screen shrink-0 flex-col self-start overflow-visible border-r border-border/35 transition-all duration-300 dark:border-border/50 sticky top-0 ${
    ...
    >
      ...
      <div
        className={`absolute left-full top-1/2 z-[5] w-24 h-32 border-r border-border/35 dark:border-border/50 origin-left pointer-events-none transition-all backface-hidden ${
